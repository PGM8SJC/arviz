(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("2902a80d-5257-414b-b122-9cf50fc74161");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '2902a80d-5257-414b-b122-9cf50fc74161' but no matching script tag was found.")
        }
